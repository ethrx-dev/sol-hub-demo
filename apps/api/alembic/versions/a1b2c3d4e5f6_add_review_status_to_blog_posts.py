...
def upgrade():
    ...
    op.create_foreign_key("fk_blog_posts_reviewed_by", "blog_posts", "users", ["reviewed_by_id"], ["id"])


def downgrade():
    op.drop_constraint("fk_blog_posts_reviewed_by", "blog_posts", type_="foreignkey")
